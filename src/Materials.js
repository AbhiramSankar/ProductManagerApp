...
function Materials() {
    ...
    async function fetchData() {
        let result = await fetch("https://prodmanbackend.000webhostapp.com/api/product/" + params.id);
        result = await result.json();
        setData(result)
    }

    async function fetchMatData() {
        let result = await fetch("https://prodmanbackend.000webhostapp.com/api/listproductmat");
        result = await result.json();
        setMatData(result)
    }
    ...
    async function deleteOp(id) {
        ...
        let result = await fetch("https://prodmanbackend.000webhostapp.com/api/deleteproductmat/" + id + "?_method=PUT", {
            method: 'POST',
            body: formData
        })
