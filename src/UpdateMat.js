...
function UpdateMat() {
    ...
    async function fetchData() {
        let result = await fetch("https://prodmanbackend.000webhostapp.com/api/productmat/" + params.id);
    ...
    async function update_prod(id) {
        ...
        let result = await fetch("https://prodmanbackend.000webhostapp.com/api/updateproductmat/" + id + "?_method=PUT", {
            method: 'POST',
            body: formData
        })
