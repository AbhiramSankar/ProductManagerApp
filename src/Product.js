...
function Product() {
    ...
    async function deleteOp(id) {
        ...
        let result = await fetch("https://prodmanbackend.000webhostapp.com/api/deleteproduct/" + id + "?_method=PUT", {
            method: 'POST',
            body: formData
        })
    ...
    async function fetchData() {
        let result = await fetch("https://prodmanbackend.000webhostapp.com/api/listproduct");
